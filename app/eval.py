...
def get_embeddings(texts: List[str]) -> List[List[float]]:
    if _SENTENCE_MODEL is not None:
        return _SENTENCE_MODEL.encode(texts, show_progress_bar=False, convert_to_numpy=True).tolist()
    ...
    raise RuntimeError("No sentence-transformers installed and OPENAI_API_KEY not set. Install sentence-transformers or set OPENAI_API_KEY.")
